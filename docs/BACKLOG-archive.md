...
Closed work, newest first. Split out of `docs/BACKLOG.md` on 2026-07-31: the
live backlog had grown to 1057 lines, of which this section was 678, and the
file that answers "what should I do next?" had become unreadable in one pass.
