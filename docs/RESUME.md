...
Next up when work resumes: the sync-speed measurement. `docs/BACKLOG.md` has
the numbers and the reason the obvious change (lowering the poll constants) is
wrong. Also see the new "## Noticed" section there.
